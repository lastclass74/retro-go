...
typedef struct
{
   ...
   uint8 *ram, *zp, *stack; /* Zero page and stack quick access */
...
extern uint8 *nes6502_getpage(int page);
extern void nes6502_setpage(int page, uint8 *ptr);

extern nes6502_t *nes6502_create(void *ram);
extern void nes6502_destroy(void **src_cpu);
